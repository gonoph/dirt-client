...
primary_config_file_path = os.environ["HOME"] + "/.dirt/config.python"
secondary_config_file_path = os.environ["HOME"] + "/.dirt/config"
AutoLoad = {}
AutoSave = []
loading = 0
...
def save_configuration():
  ...
  config_file.write("# dirt module config file generated by dirt\n")
